// File: customer_signup_page.dart

import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:chikankan/Controller/userAU.dart'; 
import 'package:chikankan/View/logintry.dart'; // Import to allow navigation back to Login
  ...
  Future<void> _handleSignUp() async {
    ...
    try {
      ...
      if (mounted && user != null) {
        // Successful sign up, navigate to the login page or home
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              // --- 3. Email Field (Crucial for Firebase Auth) ---
